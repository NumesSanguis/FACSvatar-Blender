...
class FACSVATAR_PT_zmqConnector(Panel):
...
def register():
    bpy.utils.register_class(FACSVATAR_PT_zmqConnector)


def unregister():
    bpy.utils.unregister_class(FACSVATAR_PT_zmqConnector)
